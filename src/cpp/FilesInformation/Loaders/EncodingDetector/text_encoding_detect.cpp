...
static const char TextEncodingDetect_UTF16_BOM_LE[] = { char(0xFF), char(0xFE) };
static const char TextEncodingDetect_UTF16_BOM_BE[] = { char(0xFE), char(0xFF) };
static const char TextEncodingDetect_UTF8_BOM[] = { char(0xEF), char(0xBB), char(0xBF) };

const char* TextEncodingDetect::utf16_bom_le_ = TextEncodingDetect_UTF16_BOM_LE;
const char* TextEncodingDetect::utf16_bom_be_ = TextEncodingDetect_UTF16_BOM_BE;
const char* TextEncodingDetect::utf8_bom_ = TextEncodingDetect_UTF8_BOM;
...
TextEncodingDetect::Encoding TextEncodingDetect::CheckBOM(const char *pBuffer, size_t size)
{
	// Check for BOM
...
TextEncodingDetect::Encoding TextEncodingDetect::DetectEncoding(const char *pBuffer, size_t size) const
{
...
TextEncodingDetect::Encoding TextEncodingDetect::CheckUTF8(const char *pBuffer, size_t size) const
{
...
TextEncodingDetect::Encoding TextEncodingDetect::CheckUTF16NewlineChars(const char *pBuffer, size_t size)
{
	if (size < 2)
		return None;
...
TextEncodingDetect::Encoding TextEncodingDetect::CheckUTF16ASCII(const char *pBuffer, size_t size) const
{
	int num_odd_nulls = 0;
...
bool TextEncodingDetect::DoesContainNulls(const char *pBuffer, size_t size)
{
	size_t pos = 0;
	while (pos < size)
	{
